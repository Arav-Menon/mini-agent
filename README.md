...
This is a **prototype**, not a production-level agent. It's meant to teach you how agents work from the inside out — the patterns, the loop, the tool-calling flow. Use it to learn, break it, rebuild it. Don't ship it to production.
